...
public class SubProjectControllerTest
{
    ...
    class SubProjectUpdateTests
    {
        ...
        public void updateSubProjectName() throws Exception
        {
            ...
            mockMvc.perform(MockMvcRequestBuilders.patch(Stringify.BASE_URL + "sp/name/{subProjectId}", subProject.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(newName))
                    .andDo(MockMvcResultHandlers.print())
                    .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        public void updateSubProjectNameWithInvalidName() throws Exception
        {
            ...
            Mockito.verify(subProjectService, Mockito.never()).updateSubProjectName(subProject.getId(), newName);
        }
        ...
        public void updateSubProjectHoursAmountWithInvalidAmount() throws Exception
        {
            ...
            Mockito.verify(subProjectService, Mockito.never()).updateSubProjectHours(subProject.getId(), newAmount);
        }
        ...
        public void increaseSubProjectHoursAmountWithInvalidAmount() throws Exception
        {
            ...
            Mockito.verify(subProjectService, Mockito.never()).increaseSubProjectHours(subProject.getId(), amountToAdd);
        }
        ...
        public void decreaseSubProjectHoursAmountWithInvalidAmount() throws Exception
        {
            ...
            Mockito.verify(subProjectService, Mockito.never()).decreaseSubProjectHours(subProject.getId(), amountToRemove);
        }
    }
    ...
    class SubProjectGetTests {
        ...
        class SubProjectDeleteTests {
            ...
            public void removeAssociation() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.delete(Stringify.BASE_URL + "sp/{subProjectId}/association/{userId}", 1L, 1L))
                        .andDo(MockMvcResultHandlers.print())
                        .andExpect(MockMvcResultMatchers.status().isOk());
