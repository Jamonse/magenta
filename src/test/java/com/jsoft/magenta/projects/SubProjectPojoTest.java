...
public class SubProjectPojoTest {
  ...
  public void create() {
    SubProject sp1 = new SubProject(1L, "sub-project", true, 10d, new Project(), new HashSet<>(),
        new HashSet<>());
    SubProject sp2 = new SubProject(1L, "sub-project", true, 10d, new Project(), new HashSet<>(),
        new HashSet<>());
