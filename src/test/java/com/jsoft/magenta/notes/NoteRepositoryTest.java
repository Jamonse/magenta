...
public class NoteRepositoryTest {
  ...
  public void getUserNotesByTakenAtBeforeNow() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndTakenAtLessThanEqual(user.getId(), LocalDateTime.now(), pageRequest);
  ...
  public void getUserNotesByTakenAtBeforeYesterday() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndTakenAtLessThanEqual(user.getId(), takenAt, pageRequest);
  ...
  public void getUserNotesByTakenAtAfterNow() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndTakenAtGreaterThanEqual(user.getId(), LocalDateTime.now(), pageRequest);
  ...
  public void getUserNotesByTakenAtAfterYesterday() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndTakenAtGreaterThanEqual(user.getId(), takenAt, pageRequest);
  ...
  public void getUserNotesByTakenAtAfterAWeekAgoAndNow() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndTakenAtBetween(user.getId(), startDate, LocalDateTime.now(),
            pageRequest);
  ...
  public void getUserNotesByRemindAtBeforeTwoWeeksFromNow() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndRemindAtLessThanEqual(user.getId(), endDate, pageRequest);
  ...
  public void getUserNotesByRemindAtAfterAWeekFromNow() {
    ...
    Page<UserNote> notes = this
        .userNoteRepository
        .findAllByUserIdAndRemindAtGreaterThanEqual(user.getId(), startDate, pageRequest);
  ...
  public void getUserNotesResultsByTitleExample() {
    ...
    List<UserNoteSearchResult> notes = this
        .userNoteRepository
        .findAllByUserIdAndTitleContainingIgnoreCase(user.getId(), "t", pageRequest);
