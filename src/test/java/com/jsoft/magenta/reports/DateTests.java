...
import com.jsoft.magenta.worktimes.reports.HoursStatus;
...
public class DateTests {
  ...
  public void setWeeklyHoursReportWithInvalidValues() {
    ...
    Assertions
        .assertThatThrownBy(() -> weeklyHoursReport.setWeekHours(AppConstants.HOURS_IN_WEEK + 1))
  ...
  public void createMonthlyHoursReport() {
    MonthlyHoursReport monthlyHoursReport = new MonthlyHoursReport(
        new BusinessMonth(Year.now(), Month.FEBRUARY));
