...
public class WordFormatter {
  ...
  /**
   * Returns a given string with the first letter of each character sequence divided by space
   * ("word") capitalized
   *
   * @param toCapitalizeFully string to capitalize the first letter of each word in it
   * @return a given string with the first letter of each character sequence divided by space
   * ("word") capitalized
   */
