...
public class ContactService {
    ...
    public Contact createContact(Long accountId, Contact contact) { // Verify that account exists and permission is
    ...
    public Page<Contact> getAllContacts(
        ...
        if (sortBy.equals(AppDefaults.CONTACT_DEFAULT_SORT_NAME))
            pageRequest = PageRequestBuilder.buildPageRequest(pageIndex, pageSize, AppDefaults.CONTACT_DEFAULT_SORT,
                    asc);
        else
