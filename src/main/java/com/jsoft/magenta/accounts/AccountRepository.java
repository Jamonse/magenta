...
public interface AccountRepository extends JpaRepository<Account, Long>
{
    ...
    List<AccountSearchResult> findAllResultsByNameContainingIgnoreCase(String nameExample, Pageable pageable);
    ...
    Page<Project> findAllProjectsByIdAndAssociationsUserId(Long accountId, Long id, PageRequest pageRequest);
}
