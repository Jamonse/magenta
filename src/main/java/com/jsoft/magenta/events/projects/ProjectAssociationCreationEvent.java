...
public class ProjectAssociationCreationEvent extends AssociationEvent<Long> implements
    PermissionEvent {

  private final AccessPermission accessPermission;

  public ProjectAssociationCreationEvent(Long accountId, Long associatedUserId,
