...
public class AccountAssociationCreationEvent extends AssociationEvent<Long> implements
    PermissionEvent {

  private final AccessPermission accessPermission;

  public AccountAssociationCreationEvent(Long accountId, Long associatedUserId,
