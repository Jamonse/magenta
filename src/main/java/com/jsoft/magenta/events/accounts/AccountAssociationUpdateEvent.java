...
public class AccountAssociationUpdateEvent extends AssociationEvent<Long> implements
    PermissionEvent {

  private final AccessPermission newPermission;

  public AccountAssociationUpdateEvent(Long accountId, Long associatedUserId,
