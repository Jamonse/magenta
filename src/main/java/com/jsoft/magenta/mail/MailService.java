...
public class MailService {
  ...
  public void sendWeeklyMail(Long userId, String userEmail, String userName)
      throws MessagingException { // Create
    ...
    WeeklyHoursReport weeklyHoursReport = workTimeService
        .getWeeklyHoursReport(userId, userName, businessWeek);
    // Build email data
