...
public interface ProjectRepository extends JpaRepository<Project, Long> {
  ...
  boolean existsByAssociationsUserIdAndSubProjectsIdGreaterThanEqual(Long userId,
      int subProjectsId);
  ...
  List<ProjectSearchResult> findAllResultsByNameContainingIgnoreCase(String nameExample,
      Pageable pageable);
  ...
  Page<SubProject> findAllSubProjectsByIdAndAssociationsUserId(Long projectId, Long id,
      Pageable pageable);
